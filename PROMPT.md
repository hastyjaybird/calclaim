...
Build **CalClaim v2**: a **Telegram** chatbot that helps California households find **financial aid and benefit programs** across categories (health, food, cash assistance, telecom, energy bill help, tax credits, and more), maintain a **living next-steps file** with deadlines, and get nudged until they act — not just browse links.
...
2. Gate: family already on Medi-Cal / CalFresh / SSI / CalWORKs / WIC? → YES or NO arm.  
...
6. After each meaningful action: regenerate and **send** living next-steps PDF (todos + deadlines).  
7. End of queue: fuller benefits report PDF.  
...
10. README + demo script + sample next-steps PDF.  
...
4. **Living next-steps file** — update + re-send after Sign up / Already / Remind / Skip / income selection.  
5. **Final report PDF** when queue empties.  
...
- Categorical / health-food-cash: Medi-Cal, WIC, CalFresh, SSI, CalWORKs (as gate feeders and/or offers)  
- Telecom: LifeLine  
...
- [ ] Living next-steps PDF after actions  
- [ ] Final benefits report PDF  
...
**Gate:** “Is anyone in your household already on Medi-Cal, CalFresh, SSI, CalWORKs, or WIC? [ Yes ] [ No ]”
...
**After action:** “Updated your next-steps file ↓” + document.
