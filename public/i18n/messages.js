...
window.CALCLAIM_I18N = {
  en: {
    ...
    privacy: {
      ...
      collect1: "Answers you choose while finding programs (household size, income band, offer actions)",
  ...
  es: {
    ...
    privacy: {
      ...
      collect1: "Respuestas que eliges al buscar programas (tamaño del hogar, banda de ingresos, acciones de oferta)",
  ...
  zh: {
    ...
    privacy: {
      ...
      collect1: "您在查找项目时选择的答案（家庭人数、收入区间、项目操作）",
