...
window.CALCLAIM_I18N = {
  en: {
    ...
    about: {
      ...
      eyebrow: "About",
      title: "About",
      lede: "CalClaim helps California people find financial aid and benefits — food, health, phone discounts, energy bill help, and more.",
      disclaimer:
  ...
  es: {
    ...
    about: {
      ...
      eyebrow: "Acerca de",
      title: "Acerca de",
      lede: "CalClaim ayuda a personas en California a encontrar ayuda financiera y beneficios: comida, salud, descuentos de teléfono, ayuda con la factura de energía y más.",
      disclaimer:
        "Solo estimaciones. Sin afiliación con PG&E, DHCS, CDSS, USDA, FCC, IRS ni ninguna agencia. No es asesoría fiscal, legal ni de beneficios. Las agencias oficiales deciden la elegibilidad.",
      scope:
  ...
  zh: {
    ...
    about: {
      ...
      eyebrow: "关于",
      title: "关于",
      lede: "CalClaim 帮助加州居民寻找经济援助与福利——食品、医疗、电话折扣、能源账单援助等。",
      disclaimer:
        "仅为估算。与 PG&E、DHCS、CDSS、USDA、FCC、IRS 或任何机构无关。不构成税务、法律或福利建议。正式资格由官方机构决定。",
      scope:
