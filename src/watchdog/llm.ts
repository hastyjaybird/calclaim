...
export async function analyzeProgramWithLlm(
  ...
  const librarySnapshot = {
    ...
    requiresBuyingEbikeThisYear: program.requiresBuyingEbikeThisYear ?? false,
    requiresVehicleRetirement: program.requiresVehicleRetirement ?? false,
    eligibleCounties: program.eligibleCounties ?? [],
