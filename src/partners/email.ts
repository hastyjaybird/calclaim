          ...
          <tr>
            <td style="padding:28px 28px 8px;font-family:Figtree,Helvetica,Arial,sans-serif;">
              ...
              <p style="margin:0 0 18px;font-size:15px;line-height:1.45;color:#3a5550;">
                Attached as <code>calclaim-booth-banner.pdf</code> — includes the CalClaim logo, your company name, and your QR for people to scan at your booth.
...
Booth banner to print (also attached as calclaim-booth-banner.pdf) — CalClaim logo, your company name, and your QR:
${bannerUrl}
